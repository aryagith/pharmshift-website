                ...
                >
                  ...
                  <Box>
                    <Button
                      ...
                      onClick={(e) =>
                        setResourcesAnchor(
                          resourcesAnchor ? null : e.currentTarget
                        )
                      }
                    >
                      Resources
                            ...
                            {(item === "Chatbot" ||
                              ...
                              <Typography
                                ...
                                sx={{
                                  ...
                                  letterSpacing: 0.5,
                                  background:
                                    "linear-gradient(90deg, #6a5af9, #00c6fb, #6a5af9)",
                                  WebkitBackgroundClip: "text",
                                  WebkitTextFillColor: "transparent",
                                  backgroundClip: "text",
                                  textFillColor: "transparent",
                                  animation:
                                    "gradient-move 3s ease-in-out infinite",
                                  ...
                                  textShadow:
                                    "0 1px 8px rgba(106,90,249,0.25), 0 1px 8px rgba(0,198,251,0.15)",
                                }}
                              >
                                Coming soon!
                              </Typography>
                    ...
                    <>
                      ...
                      >
                        ...
                        <MenuItem
                          ...
                          sx={{ display: "block", alignItems: "flex-start" }}
                        >
