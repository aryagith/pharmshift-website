...
export default function CareerPage() {
  ...
  const filteredJobs =
    filter === "All" ? jobs : jobs.filter((job) => job.tag === filter);
  ...
  return (
    <Box sx={{ textAlign: "center", pt: 8, pb: 12 }}>
      ...
      >
        Because innovation thrives when our team thrives together. To support
        our highly talented team, PharmShift promotes growth, development, and
        happiness across both work and personal life.
      </Typography>
      ...
      <Box mt={10} maxWidth={900} mx="auto">
        ...
        >
          ...
          <Typography variant="body2" sx={{ color: "#bbb" }}>
            Number of Active Listings: {filteredJobs.length}
          </Typography>
        </Box>
